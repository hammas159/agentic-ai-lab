"""hire-desk end to end: intake, bus, worker, approval, commit.
...
from hiredesk import agents
from hiredesk.app import runtime
...
def test_the_early_exit_costs_no_generation():
    ...
    assert row["result"]["refused_to_score"] is True
    assert model.calls == []
