"""campus-ops end to end: intake, bus, worker, approval, commit.
...
from campusops import agents
from campusops.app import runtime
...
def test_the_early_exit_costs_no_generation():
    ...
    assert row["result"]["not_publishable"] is True
    assert model.calls == []
